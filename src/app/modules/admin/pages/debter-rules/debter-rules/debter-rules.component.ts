...
export class DebterRulesComponent implements OnInit {
  ...
  onSaveChanges() {
    ...
    $.each($('i.sim-tree-checkbox'), function (index, value) {
  ...
  callServiceSaveDebterRules(cats, updated_cats, selected_group, debtor_key_in_localStorage) {
