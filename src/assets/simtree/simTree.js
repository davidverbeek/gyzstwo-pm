  ...
  function (e, t, i) {
    ...
    !(function (e, t) {
      ...
      !(function (e) {
        var t,
          i = e.document,
          s = { linkParent: !1, response: { name: "name", id: "id", pid: "pid", checked: "checked", open: "open", disabled: "disabled" } },
          n = function (e) {
            throw new Error(e);
          },
          a = function (e, t) {
        ...
        (r.prototype = {
          ...
          on: function (e, t, i) {
            ...
            return (
              ...
              $.isFunction(t) && (!0 === i ? (this.handles[e] = [t]) : this.handles[e].push(t), s && t.call(this, n)),
              this
            );
          },
          off: function (e) {
          ...
          doRender: function (e, t, s) {
            var n,
              ...
              k = p.name,
              s = s || 1,
              C = '<i data-type="{{asy}}" class="sim-tree-spread {{spreadIcon}}"></i><a href="javascript:;"><i class="sim-tree-checkbox"></i>{{text}}</a>',
              b = e === this.$el,
            ...
            for (f.check || (C = C.replace('<i class="sim-tree-checkbox"></i>', "")); g < m; g++)
              (n = t[g]),
                ...
                (c = !!n.children),
                (l = n[p.disabled]),
                (r.innerHTML = a(C, { asy: w, text: n[k], spreadIcon: c ? "sim-icon-r" : "hidden" })),
            ...
            m && e.append(y),
              b
                ? (y.addClass("sim-tree"),
                  ...
                  this.setSelected(d))
                : f.childNodeAsy && (this.hideLoading(e.find(".sim-tree-spread")), y.addClass("show"));
          },
          event: function () {
            var e = this;
          ...
          spread: function (e) {
            e.hasClass("sim-icon-r") ? this.doSpread(e, !0) : this.doSpread(e, !1);
          },
            ...
            n.children &&
              (t
                ? (e.removeClass("sim-icon-r").addClass("sim-icon-d"),
                  "asy" === e.data("type") && $.isFunction(this.data) && (this.showLoading(e), this.data(i.data("data"), this.dataCallback.bind(this, i)), e.data("type", "")),
                  s.addClass("show"))
                : (e.removeClass("sim-icon-d").addClass("sim-icon-r"), s.removeClass("show")));
          },
          ...
          search: function (e) {
            if (this.$el) {
              var t,
                ...
                d = [],
                o = new RegExp(e, "i");
              for (n.hide().children(".sim-tree-spread").addClass("hidden"); a < r; a++)
                (i = n.eq(a)),
                  (t = i.children("a").text()),
                  (s = i.data("data")),
                  e
                    ? -1 !== t.search(o) && (1 !== parseInt(i.data("level")) && this.expandNode(s[this.options.response.pid]), i.parents("li").add(i).show(), d.push(i))
                    : (i.show(), s.children && i.children(".sim-tree-spread").removeClass("hidden"));
